...
public class Problem418 {
	...
	public static void main(String []args)
	{
		...
		*/
		...
		BigInteger FortyThreeFactorial = Util.getFactorial(43);
		
		
		
		System.out.println(FortyThreeFactorial);
		
		for(BigInteger tempPrimeFactor : Util.getDistinctPrimeFactorsOf(FortyThreeFactorial))
		{
		System.out.println(tempPrimeFactor);
		}
	}
